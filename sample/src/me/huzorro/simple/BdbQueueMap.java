...
public class BdbQueueMap<K, E> extends AbstractQueue<E> implements BlockingQueue<E> {
	...
	static final class QueueEnvironment<K, E> {
		...
		public QueueEnvironment<K, E> buildEnvironment(String pathHome) {
			...
			System.out.println(environment.getConfig());
		...
		public QueueEnvironment<K, E> buildQueueMap(String queueName) {
			SerialBinding<Object> messageKeyBinding =
                    new SerialBinding<Object>(storedClassCatalog, Object.class);
            SerialBinding<Object> messageValueBinding =
                    new SerialBinding<Object>(storedClassCatalog, Object.class);
            queueDB = environment.openDatabase(null, queueName, dbConfig);
            queueMap = new StoredSortedMap<K, E>(queueDB, (EntryBinding<K>) messageKeyBinding, (EntryBinding<E>) messageValueBinding, true);
			return this;
		}
